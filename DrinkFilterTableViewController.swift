...
class DrinkFilterTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let ingredient = ingredient {
            NetworkManager.shared.fetchCocktailsByIngredient(ingredient: ingredient) { [weak self] cocktails, error in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = cocktail.strDrink
        cell.detailTextLabel?.text = cocktail.strCategory
